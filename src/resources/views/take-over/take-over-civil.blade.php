                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class=" shadow p-3 mb-5 bg-white rounded col-sm-12">
                                    <h4 class="card-title" id="entryHeading">Takeover From Civil Entry</h4><!---->
                                    <hr>
                                    ...
                                    <div class="row my-1">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class=" form-control civil_emp_id" readonly
                                                   id="civil_eng" name="civil_eng" value="{{$loggedUserCode}}">
                                        </div>
                                        <input type="hidden" name="civil_emp_id" value="{{$loggedUserId}}">
                                        <div class="col-md-3">
                                            <label>Civil Engineer's Comment</label>
                                            <textarea placeholder="Enter Civil Engineer's Comment" rows="2" wrap="soft"
                                                      name="civil_eng_comment"
                                    ...
                                    <div class="row my-1">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group date" id="datetimepicker1"
                                                ...
                                                <input type="text" value="{{date('Y-m-d')}}"
                                                       ...
                                                       required
                                                       id="take_over_date_civil"
                                                       name="take_over_date_civil"
                                                       autocomplete="off"
                                                />
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="custom-file b-form-file form-group">
                                                <input type="file" id="attach_civil" name="attach_civil"
                                                       class="custom-file-input"

                                                />
                                                <label for="attach_civil" data-browse="Browse"
...
@section('footer-script')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            select('#allotment_no_search', '/ajax/take-over-letter-civil', ajaxParams, generalAllotLetterOptions);
            ...
            $('#allotmentLetterTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: APP_URL + "/take-over-list-civil",
                columns: [
