...
@section('content')
	<div class="row">
		<div class="col-12">
            ...
            <form id="allotment-register" method="POST"  action="{{ route('takeOver.store') }}">
                {{ csrf_field() }}
...
@endsection
    ...
    $(document).ready(function() {
        select('#allotment_no_search', '/ajax/new-general-allot-letters', ajaxParams, generalAllotLetterOptions);
