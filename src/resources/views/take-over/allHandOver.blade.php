...
@section('content')
	<div class="row">
		<div class="col-12">
            ...
            <form id="allotment-register" method="POST"  action="{{ route('handOver.store') }}">
                {{ csrf_field() }}
...
{{--                                                            </div>--}}
                                    ...
                                    <div class=" shadow p-3 mb-5 bg-white rounded col-sm-12">
                                        <h4 class="card-title" id="entryHeading">Handover Entry</h4><!---->
                                        <hr>
            ...
            <div class="card"><!----><!---->
				<div class="card-body"><h4 class="card-title" id="listHeading">Handover Employee List</h4><!---->
