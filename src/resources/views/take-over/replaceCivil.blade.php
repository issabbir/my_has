...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <form id="allotment-register" method="POST" action="{{ route('replaceTakeOver.civilStore') }}">
                {{ csrf_field() }}
                                ...
                                <div class=" shadow p-3 mb-5 bg-white rounded col-sm-12">
                                    ...
                                    <div class="row my-1">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <textarea placeholder="Enter Civil Engineer's Comment" rows="2"
                                                      wrap="soft" name="civil_eng_comment"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="hidden" id="civil_engg" name="civil_eng"
