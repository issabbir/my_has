...
@section('content')
	<div class="row">
		<div class="col-12">
            ...
            <form id="allotment-register" method="POST"  enctype="multipart/form-data" action="{{ route('civilHandOver.civilStore') }}">
                {{ csrf_field() }}
...
{{--                                                    </div>--}}
                                                    ...
                                                    <div class="col-md-3" id="handOver">
                                                        <label>Employee Code</label>
                                                        <select class="custom-select" name="emp_code_search" id="emp_code_search">
                                                            <option value="">---Please Select---</option>
                                                            @foreach($data['empList'] as $emp)
                                                                <option value="{{ $emp->emp_id  }}"> {{ $emp->emp_code }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
{{--                                                            --}}
...
{{--                                                            </div>--}}
                                    ...
                                    <div class=" shadow p-3 mb-5 bg-white rounded col-sm-12">
                                        <h4 class="card-title" id="entryHeading">Civil Handover Entry Form</h4><!---->
                                        <hr>
                                        <div class="row my-1">
                                        ...
                                        <div class="row my-1">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <textarea placeholder="Enter House Details" rows="4" wrap="soft" name="house_details" readonly
                                        ...
                                        <div class="row my-1">
                                            ...
                                            <div class="col-md-3">
                                                <label class="required">Civil Engineer</label>
                                                {{--<select class="custom-select" name="civil_eng" id="civil_eng">
                                                    @foreach($data['civilEmployeeList'] as $option)
                                                        {!!$option!!}
                                                    @endforeach
                                                </select>--}}
{{--                                                <select class="custom-select select2 form-control civil_emp_id" id="civil_eng" name="civil_eng" required></select>--}}
                                                <input type="text" class="form-control" id="civil_engg" readonly name="civil_engg" value="{{$user->user()->user_name}} "required>
                                            </div>
                                            <input type="hidden" class="form-control " id="civil_eng" name="civil_eng" value="{{$user->user()->emp_id}} "required>


                                            <div class="col-md-9">
                                                <label>Civil Engineer's Comment</label>
                                                <textarea placeholder="Enter Civil Engineer's Comment" rows="4" wrap="soft" name="civil_eng_comment"
                                                          class="form-control" id="civil_eng_comment"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col-md-6">
                                                <label>Sanitary Fittings</label>
                                                <textarea placeholder="Enter Sanitary Fittings" rows="4" wrap="soft" name="sanitary_fittings"
                                                          class="form-control" id="sanitary_fittings"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col-md-3 ">
                                                ...
                                                <div class="custom-file b-form-file form-group">
                                                    <input type="file" id="civilAttachment" name="civilAttachment"
                                                           class="custom-file-input"/>
                                                    <label for="civilAttachment" data-browse="Browse"
...
@endsection
    ...
    <script type="text/javascript" >
        ...
        let entryHeading = 'Civil Handover Entry Form';
        let listHeading = 'Employee List Handover To Civil Department';
        ...
        $('#datetimepicker1').datetimepicker({
            ...
            $('#datetimepicker2').datetimepicker({
                ...
                $('#allotmentLetterTable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: APP_URL+"/civil-hand-over-list",
                    columns: [
