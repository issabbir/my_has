...
@section('content')
	<div class="row">
		<div class="col-12">
            ...
            <form id="allotment-register" method="POST"  action="{{ route('replaceTakeOver.store') }}">
                {{ csrf_field() }}
                                    ...
                                    <div class=" shadow p-3 mb-5 bg-white rounded col-sm-12">
                                        ...
                                        <div class="row my-1">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <!-- SELECT2 element is added by commenting out this! No business rule changed here. -->
                                                {{--<select class="custom-select" name="electrical_eng" id="electrical_eng">
                                                    @foreach($data['electricEmployeeList'] as $option)
                                                        {!!$option!!}
                                                    @endforeach
                                                </select>--}}
                                                <select class="custom-select select2 form-control electric_emp_id" id="electrical_eng" name="electrical_eng"></select>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="custom-select select2 form-control civil_emp_id" id="civil_eng" name="civil_eng"></select>
                                            </div>

                                            <div class="col-md-3">
                                                <label>Civil Engineer's Comment</label>
                                                <textarea placeholder="Enter Civil Engineer's Comment" rows="2" wrap="soft" name="civil_eng_comment"
                                        ...
                                        <div class="col-md-3">
                                            <label class="required" id="takeOverHandOverDateHeading">Take Over Date</label>
...
@endsection
    ...
    $(document).ready(function() {
        select('#allotment_no_search', '/ajax/new-replace-allot-letters', ajaxParams, replaceAllotLetterOptions);
        ...
        $('#allotmentLetterTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: APP_URL+"/replace-take-over-list",
            columns: [
