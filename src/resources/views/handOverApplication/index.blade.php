        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body"><h4 class="card-title">House Handover Application</h4>
                    <hr>
                    @include('handOverApplication.form')
                </div>
            </div>
        ...
        function setEmployeeInformation(data) {
            if (data.employeeInformation) {
                ...
                if (data.employeeInformation.emp_join_date) {
                    $('#join_date').val(moment(data.employeeInformation.emp_join_date, 'YYYY-MM-DD').format('DD-MM-YYYY'));
                }
        ...
        $(document).ready(function () {
            ...
            */
            ...
            $('#advertisement_id').on('change', function () {
                ...
                if (((advID !== undefined) || (advID != null)) && advID) {
                    $.ajax({
                        type: "GET",
