                ...
                <table bgcolor="#fff" cellspacing="0" cellpadding="10" border="0" width="650" style="border:7px solid #FFCC00;text-align: left;background: #fff;">
                    ...
                    <tr>
                        <td valign="top">
                            ...
                            <p style="font-size:12px; line-height:16px; margin:0 0 16px 0;color:#000;">Congratulations! Your flat has been replaced and a new flat has been allotted to you. </p>
