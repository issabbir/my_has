        ...
        <tr>
            <td align="center" valign="top" style="padding:20px 0 20px 0;color:#000;">
                ...
                <table bgcolor="#fff" cellspacing="0" cellpadding="10" border="0" width="650" style="border:7px solid #FFCC00;text-align: left;background: #fff;">
                    ...
                    <tr>
                        <td valign="top">
                            <h1 style="font-size:22px; font-weight:normal; line-height:22px; margin:0 0 11px 0;color:#000;">Dear User,</h1>
                            <p style="font-size:12px; line-height:16px; margin:0 0 16px 0;color:#000;"><a target="_blank" href="{{ route('reset-password', ['pin' => $pin]) }}">Please reset your password by clicking this line.</a></p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#fff" align="center" style="background:#fff; text-align:right;"><p style="font-size:12px; margin:0;">Thanks, <br />CPA</p></td>
                    </tr>
                </table>
            </td>
        </tr>
