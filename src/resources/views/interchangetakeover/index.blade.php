...
@section('content')
    <div class="row">
        <div class="col-12">
            <form id="house-interchange-takeover" method="POST" action="{{ route('interchange-takeover.store') }}">
                {{ csrf_field() }}
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                                        ...
                                        <div class="col-6 grid-divider">
                                            ...
                                            <div class="row my-1">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea placeholder="Enter House Details" rows="2" wrap="soft" disabled
