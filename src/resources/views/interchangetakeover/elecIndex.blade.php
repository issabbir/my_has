...
@section('content')
    <div class="row">
        <div class="col-12">
            <form id="house-interchange-takeover" method="POST" action="{{ route('interchange-takeover.elec-Store') }}">
                {{ csrf_field() }}
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class=" shadow p-1 mb-2 bg-white rounded col-12">
                                        ...
                                        <div class="col-6 grid-divider">
                                            ...
                                            <div class="row my-1">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea placeholder="Enter Sanitary Fittings" rows="2" wrap="soft" disabled
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <textarea placeholder="Enter Electrical Fittings" rows="2" wrap="soft"
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <input type="hidden" name="elecEng" value="{{$loggedUser->emp_id}}">
